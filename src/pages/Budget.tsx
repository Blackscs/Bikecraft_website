 ...
 return (
    <>
     <Section>
      ...
      <Section>
        <div class="grid grid-cols-1 md:grid-cols-5 max-w-screen-xl mx-auto shadow-md bg-none mb-32">
          <div
            id="first-col"
            class="col-span-2 bg-black flex flex-col gap-5 py-20 rounded-l-lg px-8 sm:px-28 md:px-10 lg:px-8 py-20 lg:p-20"
          >
