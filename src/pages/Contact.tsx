            ...
            <div class="grid gap-10">
              <div class="roboto-regular text-base flex flex-col bg-black text-gray-300 gap-14">
                <div class="flex gap-1">
                  <img
                    src="/assets/icons/locale_icon.svg"
                    alt="locale icon"
                    class="self-start"
                  />
                  <div class="text-sm"> 
        ...
        <div class="grid lg:grid-cols-2 gap-20 mb-40">
          <div id="card 1">
            <div class="w-full">
              <img
                ...
                src="/assets/locale/rio_de_janeiro.svg"
            ...
            <div class="flex flex-col pl-10 gap-8 mt-10">
              ...
              <div class="flex gap-3">
                <img src="/assets/icons/clock_icon.svg" alt="relogio icon" />
          ...
          <div id="card 2">
            <div class="w-full">
              <img
                class="object-cover w-full h-full"
                src="/assets/locale/sao_paulo.svg"
                alt="sao paulo image"
              />
            </div>
